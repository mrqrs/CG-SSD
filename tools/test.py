...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='./cfgs/once_models/sup_models/dynamic_anchor.yaml', help='specify the config for training')
    ...
    parser.add_argument('--ckpt', type=str, default='../output/cfgs/once_models/sup_models/dynamic_anchor/default/ckpt/checkpoint_epoch_80.pth', help='checkpoint to start from')
